...
public class UpdateFriendTypeServlet extends HttpServlet {
	private static final long serialVersionUID = 5549474590789706536L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("srcPage", "更新朋友类别");
